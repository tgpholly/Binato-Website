...
module.exports = async function(loginInfo, res) {
    const dbInfo = await global.Database.query(`SELECT id, password, password_change_required, has_old_password FROM users_info WHERE username = "${loginInfo.u}" LIMIT 1`);
